                ...
                <tbody>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="{{url('public')}}/images/cloth_1.jpg" alt="Image" class="img-fluid">
                    </td>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="{{url('public')}}/images/cloth_2.jpg" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">RP.580.000</strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">RP.630.000</strong>
                  </div>
                </div>
